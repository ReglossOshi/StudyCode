<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8"%>
	<div id="round">
        ...
        <ul id="menuUl">
            ...
            <li><a href="store" class="dir"><span class="material-symbols-outlined dir2">inventory_2</span> 입고 등록</a></li>
            <li><a href="inventory" class="dir"><span class="material-symbols-outlined dir2">inventory_2</span> 재고 관리</a></li>
