    ...
    function lineInsert(){
        ...
        replyService.add(
                ...
                function(result){
                    /*
                    var str = "";
                                        str += "<li data-rno='" + result + "' style='display:flex; align-items:center;justify-content: space-between;'>";
                                        str += "    <div class='use'>";
                                        str += "        <div>";
                                        str += "            <strong class=''>" + replyerWriter + "</strong>";
                                        str += "            <small class=''>" + replyService.displayTime(replyDate) + "</small>";

                                        //str += "            <small class=''>" + replyDate + "</small>";

                                        str += "        </div>";
                                        str += "        <p class='rep'>" + reply + "</p>" ;
                                        str += "    </div>";
                                        str +="<div class='btn'>"
                                        str +="<button onclick='listUpdate("+result+")' class='btn btn-primary btn-xs pull-right updatebtn'>수정</button>"
                                        str +="<button onclick='listDelete("+result+")' class='btn btn-primary btn-xs pull-right updatebtn2' style='margin-left: 10px;'>삭제</button>"
                                        str +="</div>"
                                        str += "</li>";
                                        replyUL.html(str);
                                        $("#reply").val('');
