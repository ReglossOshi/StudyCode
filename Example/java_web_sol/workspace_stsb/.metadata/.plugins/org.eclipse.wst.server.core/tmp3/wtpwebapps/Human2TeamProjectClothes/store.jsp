        ...
        <div class="content">
            <div id="info">
                ...
                <form action="storeInsert.jsp" id="formInsert" method="get" onsubmit="return false">
                    ...
                    <ul class="subject">
                        <li class="line"><div class="lab">입고일</div><input type="text" name="date" class="text" id="item_date" placeholder="날짜 입력"><input type="date" id="date" onchange="dateMethod()" data-placeholder="날짜 선택"></li>
                        <li class="line"><div class="lab">수량</div><input type="text" name="itemcount" class="text" id="quantity" placeholder="수량 입력"></li>
                        <li class="line"><div class="lab">제품 번호</div><input type="hidden" name="itemnum" class="text" id="item_num" placeholder="제품 번호 입력"><div id="item_num2" class="subjectbox"></div></li>
                        <li class="line"><div class="lab">제품명</div><input type="hidden" name="itemname" class="text" id="item_name" placeholder="제품명 입력"><div id="item_name2" class="subjectbox"></div></li>
                        <li class="line"><div class="lab">사이즈</div><input type="hidden" name="itemsize" class="text" id="item_size" placeholder="사이즈 입력"><div id="item_size2" class="subjectbox"></div></li>
                    </ul>
                    <div id="ok">
