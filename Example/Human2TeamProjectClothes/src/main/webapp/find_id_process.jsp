...
%>
	<div class="id_find">
		...
		<button onclick="location.href='index.jsp'" class="id_find_but">로그인</button>
	</div>	
<%				
       } else {
%> 
	<div class="id_find_fail">
	   <p>입력하신 정보로 아이디를 찾을 수 없습니다.</p>
	   <button onclick="location.href='find_id_pw.jsp'" class="id_find_fail_but">뒤로가기</button>
	</div>   
<%   	   
      }                  
	} catch(Exception e) {
