    ...
    function lineInsert(){
        ...
        replyService.add(
                ...
                function(result){
                    ...
                    showReplyList(1);
                    /*var str = "";
                    str += "<li data-rno='' style='display:flex; align-items:center;justify-content: space-between;'>";
                                             str += "    <div>";
                                             str += "        <div class=''>";
                                             str += "            <strong class=''>" + replyerWriter + "</strong>";
                                             str += "            <small class=''>" + replyService.displayTime(replyDate.getTime()) + "</small>";
                                             str += "        </div>";
                                             str += "        <p>" + reply + "</p>" ;
                                             str += "    </div>";
                                             str +="<div>"
                                             str +="<button class='btn btn-primary btn-xs pull-right'>수정</button>"
                                             str +="<button onclick='listDelete()' class='btn btn-primary btn-xs pull-right' style='margin-left: 10px;'>삭제</button>"
                                             str +="</div>"
                                             str += "</li>";
                    replyUL.append(str);
                    $("#reply").val('');*/
     ...
     var replyUL = $(".chat");
        ...
        function listUpdate(rno){
            ...
            btn2.html("취소");
            btn2.contents().unwrap().wrap("<button onclick='cancelbtn("+rno+")' class='btn btn-primary btn-xs pull-right cancel' style='background-color:red;border-color:red;margin-left:10px;'></button>");
        }
